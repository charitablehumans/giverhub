<?php return function ($in, $debugopt = 1) {
	...
	<header class="second">
		<div class="col-xs-6 left-col">Original Pot: $',htmlentities((string)((isset($in['potSize']) && is_array($in)) ? $in['potSize'] : null), ENT_QUOTES, 'UTF-8'),'</div>
        <div class="col-xs-6 right-col">Amount Remaining: $',htmlentities((string)((isset($in['amountRemaining']) && is_array($in)) ? $in['amountRemaining'] : null), ENT_QUOTES, 'UTF-8'),'</div>
	</header>
