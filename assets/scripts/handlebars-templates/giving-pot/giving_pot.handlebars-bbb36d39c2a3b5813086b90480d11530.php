<?php return function ($in, $debugopt = 1) {
	...
	<a href="';if (LCRun3::ifvar($cx, ((isset($in['buttonUrl']) && is_array($in)) ? $in['buttonUrl'] : null))){echo '',htmlentities((string)((isset($in['buttonUrl']) && is_array($in)) ? $in['buttonUrl'] : null), ENT_QUOTES, 'UTF-8'),'';}else{echo '#';}echo '" target="_blank" type="button" class="btn btn-primary">';if (LCRun3::ifvar($cx, ((isset($in['buttonText']) && is_array($in)) ? $in['buttonText'] : null))){echo '',htmlentities((string)((isset($in['buttonText']) && is_array($in)) ? $in['buttonText'] : null), ENT_QUOTES, 'UTF-8'),'';}else{echo '[BUTTON TEXT]';}echo '</a>
