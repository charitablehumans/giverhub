 ...
 */
class CharityKeywordVote extends \Entity\CharityKeywordVote implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'keyword_id', 'user_id', 'vote');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CharityKeywordVote $proxy) {
