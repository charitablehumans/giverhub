 ...
 */
class PetitionFacebookShare extends \Entity\PetitionFacebookShare implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'date', 'petition', 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PetitionFacebookShare $proxy) {
