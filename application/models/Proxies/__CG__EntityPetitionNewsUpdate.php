 ...
 */
class PetitionNewsUpdate extends \Entity\PetitionNewsUpdate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'petition_id', 'user_id', 'content', 'created_on');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PetitionNewsUpdate $proxy) {
