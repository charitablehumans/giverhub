 ...
 */
class SitemapLetters extends \Entity\SitemapLetters implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'letter', 'types', 'type', 'count');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SitemapLetters $proxy) {
