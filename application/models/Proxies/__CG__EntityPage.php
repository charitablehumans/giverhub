 ...
 */
class Page extends \Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'description', 'logo', 'name', 'urlSlug');
        }
    ...
    public function getPageUsers()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPageUsers', array());

        return parent::getPageUsers();
    }
