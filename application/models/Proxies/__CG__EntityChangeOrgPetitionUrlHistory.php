 ...
 */
class ChangeOrgPetitionUrlHistory extends \Entity\ChangeOrgPetitionUrlHistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'petition_id', 'giverhub_url_slug');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChangeOrgPetitionUrlHistory $proxy) {
