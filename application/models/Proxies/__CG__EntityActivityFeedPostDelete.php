 ...
 */
class ActivityFeedPostDelete extends \Entity\ActivityFeedPostDelete implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'user_id', 'activity_feed_post_id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ActivityFeedPostDelete $proxy) {
