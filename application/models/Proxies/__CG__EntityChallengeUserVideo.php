 ...
 */
class ChallengeUserVideo extends \Entity\ChallengeUserVideo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'youtubeVideoId', 'filename', 'filetype');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChallengeUserVideo $proxy) {
