 ...
 */
class PetitionUrlSlug extends \Entity\PetitionUrlSlug implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'urlSlug', 'petition');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PetitionUrlSlug $proxy) {
