 ...
 */
class CharityImage extends \Entity\CharityImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'image_name', 'image_thumb', 'charity_id', 'show_image', 'upload_date', 'user_id');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CharityImage $proxy) {
    ...
    public function setShowImage($showImage)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setShowImage', array($showImage));
    ...
    public function getShowImage()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getShowImage', array());
