 ...
 */
class SitemapPages extends \Entity\SitemapPages implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'letter', 'types', 'type', 'page', 'entityId');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SitemapPages $proxy) {
    ...
    public function getLetter()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLetter', array());
    ...
    public function setLetter($letter)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLetter', array($letter));
