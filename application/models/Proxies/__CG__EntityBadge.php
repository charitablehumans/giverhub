 ...
 */
class Badge extends \Entity\Badge implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'user_id', 'category_id', 'points');
        }
     ...
     * {@inheritDoc}
     */
    public function setCategory(\Entity\CharityCategory $category)
    {
