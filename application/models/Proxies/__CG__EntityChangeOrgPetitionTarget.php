 ...
 */
class ChangeOrgPetitionTarget extends \Entity\ChangeOrgPetitionTarget implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'petition_id', 'name', 'type', 'first');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChangeOrgPetitionTarget $proxy) {
