 ...
 */
class CharityCategory extends \Entity\CharityCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CharityCategory $proxy) {
    ...
    public function fromObject($object)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'fromObject', array($object));
