 ...
 */
class ZipCode extends \Entity\ZipCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'zip', 'city', 'state', 'fullState', 'cityId', 'stateId');
        }
    ...
    public function getFullState()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFullState', array());

        return parent::getFullState();
    }
