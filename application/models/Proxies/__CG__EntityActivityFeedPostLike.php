 ...
 */
class ActivityFeedPostLike extends \Entity\ActivityFeedPostLike implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'entities', 'id', 'date', 'entityId', 'entityName', 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ActivityFeedPostLike $proxy) {
