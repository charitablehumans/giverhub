 ...
 */
class PageUser extends \Entity\PageUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'page', 'user');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageUser $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setPage(\Entity\Page $page)
    {
