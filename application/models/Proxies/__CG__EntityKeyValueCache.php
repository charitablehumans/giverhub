 ...
 */
class KeyValueCache extends \Entity\KeyValueCache implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'key', 'value', 'updated');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (KeyValueCache $proxy) {
