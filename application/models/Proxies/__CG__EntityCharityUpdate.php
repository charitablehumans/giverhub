 ...
 */
class CharityUpdate extends \Entity\CharityUpdate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'charity_id', 'user_id', 'date', 'update');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CharityUpdate $proxy) {
    ...
    public function setUpdate($update)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUpdate', array($update));
