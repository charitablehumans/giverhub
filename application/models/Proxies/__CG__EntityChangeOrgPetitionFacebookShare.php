 ...
 */
class ChangeOrgPetitionFacebookShare extends \Entity\ChangeOrgPetitionFacebookShare implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'date', 'user', 'petition');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ChangeOrgPetitionFacebookShare $proxy) {
