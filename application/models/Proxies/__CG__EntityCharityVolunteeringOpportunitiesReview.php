 ...
 */
class CharityVolunteeringOpportunitiesReview extends \Entity\CharityVolunteeringOpportunitiesReview implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'rating', 'valid_ratings', 'review', 'created', 'updated', 'user', 'charity');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CharityVolunteeringOpportunitiesReview $proxy) {
